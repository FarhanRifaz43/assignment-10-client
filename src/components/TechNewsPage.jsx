        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="container mx-auto p-4 flex">
                <main className="w-2/3 pr-4">
                    <div className="bg-white p-4 shadow-xl mb-4 flex gap-5 rounded-lg">
                        <img className="w-64 rounded-lg" src="https://i.ibb.co/RDf8Nbc/Power-Solar-480x480.webp" alt="" />
                        <div>
                    ...
                    <div className="bg-white p-4 shadow-xl mb-4 flex gap-5 rounded-lg">
                        <img className="w-64 rounded-lg" src="https://i.ibb.co/9qBM50s/wordpress-923188-1280.jpg" alt="" />
                        <div>
                    ...
                    <div className="bg-white p-4 shadow-xl mb-4 flex gap-5 rounded-lg">
                        <img className="w-64 rounded-lg" src="https://i.ibb.co/ZXd8bVQ/alexandre-debieve-FO7-JIlwj-Ot-U-unsplash.jpg" alt="" />
                        <div>
                    ...
                    <div className="bg-white p-4 shadow-xl mb-4 flex gap-5 rounded-lg">
                        <img className="w-64 rounded-lg" src="https://i.ibb.co/XzwS9b8/maxim-hopman-Iay-KLkmz6g0-unsplash.jpg" alt="" />
                        <div>
