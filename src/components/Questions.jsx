const Questions = () => {
    return (
        <div className="w-3/4 mx-auto my-24">
            <h2 className="font-bold text-center text-3xl mb-8" data-aos="zoom-in-up">Frequently Asked Questions</h2>
            <div data-aos="fade-up">
                <div className="collapse collapse-arrow bg-gray-100 shadow-md mb-2 text-black">
                    <input type="radio" name="my-accordion-2" />
                    <div className="collapse-title text-xl font-bold pl-8 text-black">
